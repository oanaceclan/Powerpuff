...
public class Constants {
	...
	public final static String EvoPortal = "http://172.22.4.88:9091/login";

	public final static String DMUserName = "Roxana";

	public final static String UserName = "Oana";
	...
	public final static int StartDate = 10;

	public final static String MonthForStartDate = "August";

	public final static int YearForStartDate = 2015;

	public final static int EndDate = 10;

	public final static String MonthForEndDate = "September";

	public final static int YearForEndDate = 2015;
